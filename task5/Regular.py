...
string_1 = 'I have two emails one of this is arina.kondrashevich@mail.ru' \
           ' and the other one is beliashik97@mail.ru '
emails = re.findall(r'\w+@\w+\.\w+', string_1)
print(emails)


# find all 3, 4, 5 characters long words in a string.
string_2 = 'Hello! My name is Aryna. I''m student of Belarusian state' \
