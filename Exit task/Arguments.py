    ...
    with open(f, 'r') as fp:
        for line in fp:
            if s in line:
                ...
                counter += 1
                if(arguments.year is False, arguments.rate is False,
                   arguments.histogram is False, arguments.all is False,
                   arguments.output is False):
                    print(name)
            if counter == 250:
                break
